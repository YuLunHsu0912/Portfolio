...
diff = np.zeros((416, 624), dtype=float)
b=0
while b < 6240:
    a=0
    while a <4160:
        ...
        FinalB[int(a / 10)][int(b / 10)] = top / down
        a=a+10
    b=b+10
b=0
while b < 6240:
    ...
    while a <4160:
        ...
        FinalG[int(a / 10)][int(b / 10)] = top / down
        a=a+10
    b=b+10
...
while b < 6240:
    ...
    while a <4160:
        ...
        FinalR[int(a / 10)][int(b / 10)] = top / down
        a=a+10
    b=b+10
...
HDR=np.zeros((416,624,3),dtype=float)
a=0
while a < 416:
    b=0
    while b<624:
