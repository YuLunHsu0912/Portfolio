...
while b < 6240:
    ...
    while a <4160:
        ...
        arr = [(x[B1[a][b]] - B[0]), (x[B2[a][b]] - B[1]), (x[B3[a][b]] - B[2]), (x[B4[a][b]] - B[3]),
               (x[B5[a][b]] - B[4]), (x[B6[a][b]] - B[5]), (x[B7[a][b]] - B[6])]
        if (np.var(arr) > 0.7):
            FinalB[int(a / 4)][int(b / 4)] = x[B5[a][b]] - B[4]
        elif (down != 0):
...
while b < 6240:
    ...
    while a <4160:
        ...
        arr = [(x2[G1[a][b]] - B[0]), (x2[G2[a][b]] - B[1]), (x2[G3[a][b]] - B[2]), (x2[G4[a][b]] - B[3]),
               (x2[G5[a][b]] - B[4]), (x2[G6[a][b]] - B[5]), (x2[G7[a][b]] - B[6])]
        if (np.var(arr) > 0.7):
            FinalG[int(a / 4)][int(b / 4)] = x2[G5[a][b]] - B[4]
        elif (down != 0):
...
while b < 6240:
    ...
    while a <4160:
        ...
        arr = [(x3[R1[a][b]] - B[0]), (x3[R2[a][b]] - B[1]), (x3[R3[a][b]] - B[2]), (x3[R4[a][b]] - B[3]),
               (x3[R5[a][b]] - B[4]), (x3[R6[a][b]] - B[5]), (x3[R7[a][b]] - B[6])]
        if (np.var(arr) > 0.7):
            FinalR[int(a / 4)][int(b / 4)] = x3[R5[a][b]] - B[4]
        elif (down != 0):
